...
(function(module){
  ...
  //  Refactor this function, so it accepts an argument of a callback function (likely a view function)
  ...
  Article.allAuthors = function() {
    return Article.all.reduce(function(prev, current, idx, array){
      var thisAuthor = current.author;
      if (prev.indexOf(thisAuthor) === -1){
        prev.push(thisAuthor);
        return prev;
      } else {
        return prev;
      }
